...
# cargar los datos# carga
labels, data = unpickle('cifar-10-batches-py/cifar-10-batches-py/test_batch')
print(type(data))
print(type(labels))

# forma del dataset# forma
...
plt.savefig('./figures/cifar2.jpg')
